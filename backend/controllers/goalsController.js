...
export const logGoal = async (req, res, next) => {
    ...
    try {
        const result = await pool.query(
            'INSERT INTO goals (user_id, goal_name, goal_description, target_amount, start_date, end_date) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [user_id, goal_name, description, amount, start_date, end_date]
        )
